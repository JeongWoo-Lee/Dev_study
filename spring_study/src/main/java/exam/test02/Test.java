...
public class Test {
	...
	public static void main(String[] args) {
		...
		if (scoreOk != null)
			System.out.println("score-ok! 찾았음.");
		...
		if (score4 == scoreOk)
			System.out.println("score4 == scoreOk");
		
		score2.setEng(10);
		score3.setEng(50);
		score4.setEng(70);
		
		System.out.println(score2.getEng());
		System.out.println(score3.getEng());
		System.out.println(score4.getEng());
